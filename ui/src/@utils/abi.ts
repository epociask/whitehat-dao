...
export const auditorDaoABI: AbiItem[] = [
	{
		"inputs": [
			{
				"internalType": "string",
...
export const bountyABI: AbiItem[] = [
	{
		"inputs": [
			{
				"internalType": "address",
...
export const companyDaoABI: AbiItem[] = [
	{
		"inputs": [
			{
				"internalType": "string",
...
export const sbtABI: AbiItem[] = [
	...
	},
	{
		...
		"outputs": [
			{
				"internalType": "enum Lib.Reputation",
				"name": "",
				"type": "uint8"
			}
		],
