...
function Web3Provider({ children }: { children: ReactNode }): ReactElement {
  ...
  const [ethersWeb3Provider, setEthersWeb3Provider] = useState<any>()
  ...
  const connect = useCallback(async () => {
    ...
    try {
      ...
      // const test2 = await provider.getBlockNumber()

      // console.log(test, test2);
      setEthersWeb3Provider(ethersProvider)
